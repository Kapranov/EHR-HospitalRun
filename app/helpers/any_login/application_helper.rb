  ...
  module ApplicationHelper
    ...
    if AnyLogin.enabled
      ...
      def any_login_submit
        submit_tag AnyLogin.login_button_label, class: 'btn btn-default', disabled: :disabled
      end
      ...
      def select_html_options
        options = {}
        options = { include_blank: true, class: 'select2', data: { placeholder: AnyLogin.select_prompt, theme: 'gray-lighter', arrow: '2x', padding: '1x', font: '1x', width: '165px' } }
        options
      end
