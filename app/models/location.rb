class Location
  ...
  attr_accessor :location_phone_code, :location_phone_tel
  attr_accessor :location_fax_code, :location_fax_tel
  ...
  def get_phones
    if self.location_phone.present?
      self.location_phone_code = self.location_phone[2..4]
      self.location_phone_tel = self.location_phone[4..self.location_phone.size-1]
    end
    if self.location_fax.present?
      self.location_fax_code = self.location_fax[2..4]
      self.location_fax_tel = self.location_fax[4..self.location_fax.size-1]
    end
  end

  def set_phones
    self.location_phone = [self.location_phone_code, self.location_phone_tel].join
    self.location_fax = [self.location_fax_code, self.location_fax_tel].join
  end
